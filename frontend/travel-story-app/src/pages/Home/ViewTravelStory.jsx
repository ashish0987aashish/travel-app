  ...
  return (
    <div className="relative  ">
      <div className="flex items-center justify-end">
        <div>
          <div className="flex items-center gap-3 bg-cyan-50/50 rounded-l-lg">
            ...
            <button
              className="btn-delete flex justify-center items-center"
            ...
            <button className="" onClick={onClose}>
              <MdClose className="text-xl text-gray-500 rounded-sm" />
            </button>
          </div>
        </div>
      </div>
      ...
      <div>
            ...
            <div className="inline-flex items-center gap-2 text-[13px] text-cyan-600 bg-cyan-200/40 rounded px-2 py-1">
              ...
              {storyInfo &&
                storyInfo.visitedLocation.map((item, index) =>
                  storyInfo.visitedLocation.lenth == index + 1
                    ? `${item}`
                    : `${item},`
                )}
            </div>
        ...
        <div className="mt-4">
          <p className="text-sm text-slate-950 leading-6 whitespace-pre-line">
            {storyInfo.story}
          </p>
        </div>
      </div>
